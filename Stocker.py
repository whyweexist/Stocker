# Stocker Web App by Dhruv Tiwari
...
st.sidebar.image("Images/Stocker.png", width=250,
...
if(selected == 'Stocks Performance Comparison'):  # if user selects 'Stocks Performance Comparison'
    ...
    dict_csv = pd.read_csv('StockerTickersData.csv', header=None, index_col=0).to_dict()[1]  # read csv file
